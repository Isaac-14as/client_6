...
const RegisterUserForm = () => {
    const [createUser, infoCreateUser] = authAPI.useCreateUserMutation()
    ...
    return (
        <div className={classes.UserForm}>
            ...
            <form className={classes.MainForm}  action="">
                ...
                {!infoCreateUser.isError && formSent && <div className={classes.notError}>Пользователь упешно зарегистрировался.</div>}
